...
function init_add_event(val, list, arr, change_event_name, deleat_event_name) {
  ...
  div.innerHTML =
    ...
    "<button class='original_btn' onclick=" + deleat_event_name + "(this) tabindex='-1'>削除</button>";
...
function normal_lesson_add_event(val, parent) {
  ...
  div.innerHTML =
    ...
    '<input type="button" value="削除" onclick="normal_lesson_deleat_btn(this)" tabindex="-1">';
...
function elective_lesson_list_add_event(val, parent) {
  ...
  div.innerHTML =
    ...
    '<input type="button" value="削除" onclick="elective_lesson_list_deleat_btn(this)" tabindex="-1">';
...
function elective_lesson_add_event(val1, val2, parent) {
  ...
  div.innerHTML =
    ...
    '<select class="room_select" onchange="selecter_change_event(this)"></select>' +
    '<input type="button" class="get_lesson_num_btn" value="o" onclick="get_lesson_num_btn(this)">' +
    '<input type="button" value="削除" onclick="elective_lesson_deleat_btn(this)" tabindex="-1">';
  div.getElementsByClassName("teacher_select")[0].innerHTML = selector_create(teacher_list).innerHTML;
  div.getElementsByClassName("room_select")[0].innerHTML = selector_create(room_list).innerHTML;
